...
class HttpUploaderImpl {
 public:
  ...
  // Always ready: upload_buffer_ grows as needed.
...
// the |wake_condition_| condition variable without locking |upload_buffer_|,
...
// TODO(tomfinegan): THE COMMENT'S A LIE
