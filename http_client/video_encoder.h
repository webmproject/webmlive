...
const uint16 kYV12BitCount = kI420BitCount;
const uint16 kYUY2BitCount = 16;
const uint16 kUYVYBitCount = kYUY2BitCount;
const uint16 kBGRBitCount = 24;
const uint16 kBGRABitCount = 32;
...
// not recognized. Always returns false when |ptr_format| is NULL. The
// |bits_per_pixel| argument
