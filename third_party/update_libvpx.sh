...
readonly LIBVPX_TARGET_LIB_DIRS=(win/x64/debug
                                 win/x64/release
                                 win/x86/debug
                                 win/x86/release)
...
# Print the new snippet for README.webmlive.
cat << EOF
Libvpx includes and libraries updated. README.webmlive information follows:
