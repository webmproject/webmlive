...
# install_libyuv() to update webmdlive's version of the libyuv includes and
# libraries.
update_libyuv() {
...
readonly LIBYUV_TARGET_LIB_DIRS=(win/x64/debug
                                 win/x64/release
                                 win/x86/debug
                                 win/x86/release)
...
Libyuv includes and libraries updated. README.webmlive information follows:
