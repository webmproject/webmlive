...
Step 1: Setup webmlive/testing/test_server.py:
  ...
  $ python path/to/webmlive/testing/test_server.py 8001
...
Step 5: Run encoder:
  ...
  $ webmlive/encoder.exe --url localhost:8000/dash --dash_name webmlive

Step 6: Watch your stream:
  Open a browser that supports DASH playback and open
